...
export default async function HomePage() {
  ...
  return <>
    <section className="lux-hero"><Image className="lux-hero__background" src="/images/hero.avif" alt="" fill priority sizes="100vw" aria-hidden="true" /><div className="lux-hero__grid shell"><div className="lux-hero__copy"><h1>{t.heroTitle}</h1><p>{t.heroText}</p><BookingButton className="button button--ivory hero-booking"><CalendarCheck /> {getUi(language).booking.button} <ArrowUpRight /></BookingButton></div></div></section>
